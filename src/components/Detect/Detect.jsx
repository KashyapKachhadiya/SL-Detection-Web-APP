...
import TrainedModel from "../../Trained Model/abc.task";
...
import DisplayImg from "../../assests/sgp.png";
...
const Detect = () => {
  ...
  useEffect(() => {
    async function loadGestureRecognizer() {
      ...
      //set path for abc.task in the modelAssetPath
      // 
      const modelAssetPath = TrainedModel;
